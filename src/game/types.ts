...
export const CRAFTS: Record<CraftId, CraftDef> = {
  viuda: {
    ...
    desc: "Una fortaleza flotante: tres pisos que recorren toda la cubierta y torre de mando en popa. Ocho motores de 700 HP la estiran hasta 280 NUDOS, pero sus toneladas hacen que arranque lenta. Browning .50 y 4 MISILES BR-8.",
    topSpeed: 118.3,
    accel: 6.2,
    turn: 1.6,
    hull: 100,
