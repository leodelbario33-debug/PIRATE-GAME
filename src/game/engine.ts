  ...
  private updateCamera(dt: number) {
    ...
    if (this.mode === "sea") {
      ...
      if (this.craftId === "kraken") {
        ...
        const dist = this.zoom ? 8 : this.craftId === "tiburon" ? 17 : this.craftId === "viuda" ? 30 : this.craftId === "rayo" ? 19 : this.craftId === "bala" ? 26 : 13;
        const height = this.submerged ? 6.4 : this.zoom ? 3 : this.craftId === "viuda" ? 10 : this.craftId === "rayo" ? 7 : this.craftId === "bala" ? 9 : 5.2;
        targetPos.copy(p).addScaledVector(back, -dist).add(new THREE.Vector3(0, height, 0));
